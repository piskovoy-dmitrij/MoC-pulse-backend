...
func (this *Sender) Send(users []auth.User, voteResultStatus *storage.VoteResultStatus, dbConnectionAddress string) {
	go this.send(users, voteResultStatus, dbConnectionAddress)
}
...
func (this *Sender) send(users []auth.User, voteResultStatus *storage.VoteResultStatus, dbConnectionAddress string) {
	...
	voteWithResult := voteResultStatus.Vote
